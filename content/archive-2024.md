---
title: Archive 2024
description: Archive 2024
slug: archive-2024
layout: builder
sections:
  - template: page-header
    title: 'Kubetrain 2024, <span class="text-primary">Paris</span>'
    class: "text-[83px]"
    description: >
      About Kubetrain
    image: "images/achieve-bg.jpg"
  - template: page-achieve-edition-numbers
    title: "Edition in Numbers"
    items:
      - value: "130"
        label: "Happy Travelers"
      - value: "200"
        label: "KubeTrain Party Attendees"
      - value: "60"
        label: "Unique Companies Represented"
      - value: "15+"
        label: "Countries Represented"

  - template: page-achieve-locations
    title: "Four Different Location"
  ...
  - template: page-achieve-gallery
    title: "Gallery"
    images:
      - "images/archive-2024/memory-4.png"
      - "images/archive-2024/memory-5.png"
