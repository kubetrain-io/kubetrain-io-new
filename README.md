...
Direct terminal to site folder `kubetrain`
...
1. **Project name**
   Enter your desired project name (for example: `kubetrain`).
   Your site will be deployed to `kubetrain.pages.dev`.
...
3. When the build process finishes, your site will be live at:
   ...
   Example: `https://kubetrain.pages.dev`
